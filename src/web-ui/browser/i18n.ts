...
var I18N: Record<string, Record<string, string>> = {
  "中文": {
    ...
    "subagent.interrupted": "未完成",
    "subagent.no_output": "（无输出）",
    "subagent.no_task": "未提供任务说明",
    "subagent.steps": "{count} 步",
    "subagent.preview.latest": "最新进展",
    "subagent.preview.result": "最终结论",
    "subagent.preview.error": "失败原因",
    "subagent.preview.status": "当前状态",
    "subagent.waiting": "等待子代理输出…",
    "subagent.summary_aria": "{name}，{status}。任务：{task}",
  ...
  "English": {
    ...
    "subagent.interrupted": "Incomplete",
    "subagent.no_output": "(no output)",
    "subagent.no_task": "No task description",
    "subagent.steps": "{count} steps",
    "subagent.preview.latest": "Latest",
    "subagent.preview.result": "Conclusion",
    "subagent.preview.error": "Failure",
    "subagent.preview.status": "Status",
    "subagent.waiting": "Waiting for subagent output…",
    "subagent.summary_aria": "{name}, {status}. Task: {task}",
