...
var I18N: Record<string, Record<string, string>> = {
  "中文": {
    ...
    "agentRun.count": "{count} 个 Agent",
    "agentRun.status.failed": "失败",
    "agentRun.status.running": "运行中",
    "agentRun.status.interrupted": "已中断",
    "agentRun.status.completed": "已完成",
    "agentRun.latest": "最新",
    "agentRun.noOutput": "（无输出）",
    "agentRun.noTask": "未提供任务说明",
    "agentRun.agent": "Agent",
    "agentRun.agent_list": "Agent 列表",
    "agentRun.result.done": "最终结果",
    "agentRun.result.failed": "失败原因",
    "agentRun.waiting": "等待 Agent 输出…",
    "agentRun.summary_aria": "Agent 运行，{count} 个 Agent，{status}。最新：{latest}",
  ...
  "English": {
    ...
    "agentRun.latest": "Latest",
    "agentRun.noOutput": "(no output)",
    "agentRun.noTask": "No task description",
    "agentRun.agent": "Agent",
    "agentRun.agent_list": "Agents",
    "agentRun.result.done": "Final result",
    "agentRun.result.failed": "Failure reason",
    "agentRun.waiting": "Waiting for agent output…",
    "agentRun.summary_aria": "Agent run, {count} agents, {status}. Latest: {latest}",
