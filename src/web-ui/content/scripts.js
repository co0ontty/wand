...
(() => {
  ...
  function bindGlobalListenersOnce() {
    ...
    document.addEventListener("click", function(e) {
      ...
      var button = target.closest("#check-update-button, #do-update-button, #do-restart-button");
  ...
  function loadSettingsData() {
    fetch("/api/settings", { credentials: "same-origin" }).then(function(res) {
      ...
      syncCommitModelProvider(false);
      var defaultModels = cfg.defaultModels && typeof cfg.defaultModels === "object" ? cfg.defaultModels : { claude: cfg.defaultModel || "", codex: cfg.defaultCodexModel || "" };
  ...
  function saveConfigSettings() {
    ...
    var body = {
      ...
      commitCli: (document.getElementById("cfg-commit-cli") || {}).value === "codex" ? "codex" : "claude",
