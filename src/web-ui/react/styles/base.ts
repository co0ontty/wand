...
.wand-ui-badge-info {
  border-color: color-mix(in srgb, var(--info) 22%, var(--border-default));
  color: var(--info);
...
.wand-ui-skeleton {
  ...
  background:
    linear-gradient(
      100deg,
      transparent 20%,
      color-mix(in srgb, var(--bg-elevated) 82%, white) 48%,
      transparent 76%
    ),
    var(--bg-tertiary);
  background-size: 220% 100%;
  animation: wand-ui-skeleton-shimmer 1.35s ease-in-out infinite;
}

@keyframes wand-ui-skeleton-shimmer {
